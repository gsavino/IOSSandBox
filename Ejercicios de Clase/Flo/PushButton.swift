...
class PushButton: UIButton {
    ...
    private struct Constants {
        ...
        static let plusButtonScales: CGFloat = 0.6
    ...
    //set up the width and hight variables
    //for the horizontal stroke
        let plusWidth: CGFloat = min(bounds.width, bounds.height) * Constants.plusButtonScales
        let halfPlusWidth = plusWidth / 2
        // Create the path
        let plusPath = UIBezierPath()
        //set the path"s line width to the heigt of the stroke
        plusPath.lineWidth = Constants.plusLineWidth
        //move the initail point to the path
    ...
    //Muevo el punto a la parte superior
    //
        if isAddButton
        {
